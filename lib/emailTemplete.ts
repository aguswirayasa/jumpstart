export const registerTemplete = (link: string) => {
  return `<!doctype html>
                   ...
                   <table cellpadding="0" cellspacing="0" width="100%">
                     <tr>
                      <td width="560" class="es-m-p0r" valign="top" align="center">
                       <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                         <tr>
                          <td align="center" class="es-p20b" style="font-size: 0px"><amp-img src="https://qaccwz.stripocdn.email/content/guids/CABINET_007fd6d911746fa916110d380f5a71d197b1c23c7091455b9d2f8cc0172ea429/images/replicateprediction243qrfrbwn6umefu2jnokmfr24.png" alt="Logo" style="display:block;font-size:12px" width="200" title="Logo" height="47"></amp-img></td>
                         </tr>
                       </table></td>
                     </tr>
                   </table></td>
                   ...
                   <table cellpadding="0" cellspacing="0" width="100%">
                     <tr>
                      <td width="560" align="center" valign="top">
                       <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                         <tr>
                          <td align="center" class="es-p10t es-p10b" style="font-size: 0px"><amp-img src="https://qaccwz.stripocdn.email/content/guids/CABINET_67e080d830d87c17802bd9b4fe1c0912/images/55191618237638326.png" alt="" style="display: block" width="100" height="72"></amp-img></td>
                         </tr>
                         <tr>
                         ...
                         <tr>
                          <td align="center" class="es-p10t es-p10b"><span class="es-button-border" style="border-radius: 6px;cursor: pointer"><a href=${link} class="es-button" target="_blank" style="border-left-width: 30px;border-right-width: 30px;border-radius: 6px">CONFIRM YOUR EMAIL</a></span></td>
                         </tr>
                         <tr>
                         ...
                         <tr>
                          <td align="center" class="es-p15t es-p15b" style="font-size:0">
                           <table cellpadding="0" cellspacing="0" class="es-table-not-adapt es-social" role="presentation">
                             <tr>
                              <td align="center" valign="top" class="es-p40r"><amp-img title="Facebook" src="https://qaccwz.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png" alt="Fb" width="32" height="32"></amp-img></td>
                              <td align="center" valign="top" class="es-p40r"><amp-img title="Twitter" src="https://qaccwz.stripocdn.email/content/assets/img/social-icons/logo-black/twitter-logo-black.png" alt="Tw" width="32" height="32"></amp-img></td>
                              <td align="center" valign="top" class="es-p40r"><amp-img title="Instagram" src="https://qaccwz.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png" alt="Inst" width="32" height="32"></amp-img></td>
                              <td align="center" valign="top"><amp-img title="Youtube" src="https://qaccwz.stripocdn.email/content/assets/img/social-icons/logo-black/youtube-logo-black.png" alt="Yt" width="32" height="32"></amp-img></td>
                             </tr>
                           </table></td>
                         </tr>
                         <tr>
                          <td align="center" class="es-p35b"><p>Jumstart © 2023 Jumstart, Inc. All Rights Reserved.</p><p>4562 Hazy Panda Limits, Chair Crossing, Kentucky, US, 607898</p></td>
                         </tr>
                         <tr>
                          <td>
...
export const promotionEmailTemplate = (
  subject: string,
  body: string,
  storeUrl: string
) => {
  ...
  * {
  ...
  table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_heading_2 .v-container-padding-padding { padding: 40px 10px 0px !important; } #u_content_text_3 .v-container-padding-padding { padding: 10px 10px 20px !important; } #u_content_button_2 .v-container-padding-padding { padding: 10px 10px 40px !important; } #u_content_button_2 .v-size-width { width: 55% !important; } #u_content_social_1 .v-container-padding-padding { padding: 40px 10px 10px !important; } #u_content_text_11 .v-container-padding-padding { padding: 10px 10px 20px !important; } #u_content_image_6 .v-container-padding-padding { padding: 20px 10px 40px !important; } }
      </style>
  ...
  <table id="u_content_heading_2" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <h1 style="margin: 0px; color: #2563eb; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 34px; font-weight: 700;"><strong>${subject}</strong></h1>
  ...
  <table id="u_content_text_3" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    <tbody>
      <tr>
        <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 50px 30px;font-family:'Open Sans',sans-serif;" align="left">
  ...
  <div align="center">
    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://www.unlayer.com" style="height:37px; v-text-anchor:middle; width:174px;" arcsize="11%"  stroke="f" fillcolor="#f1c40f"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
      <a href="${storeUrl}" target="_blank" class="v-button v-size-width" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #f1c40f; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:30%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
  ...
  <div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
    <div style="background-color: #2563eb;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
    <!--[if (!mso)&(!IE)]><!--><div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
  ...
  <p style="line-height: 170%;">© 2023 Jumpstart Retail. All rights reserved.</p>
    </div>
