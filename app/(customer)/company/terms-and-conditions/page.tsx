    ...
    <div className="m-10 md:m-36">
      ...
      <div className="space-y-3 text-justify">
        ...
        <p>
          ...
          use of Jumpstart Retail's Website, located at jumpstart.com.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Jumpstart Retail if you do not
        ...
        <h3 className="text-xl md:text-2xl font-bold">Cookies</h3>
        <p>
          We employ the use of cookies. By accessing Jumpstart Retail, you
          agreed to use cookies in agreement with the Jumpstart Retail's Privacy
          Policy.
        </p>
        <p>
        ...
        <h3 className="text-xl md:text-2xl font-bold">License</h3>
        <p>
          Unless otherwise stated, Jumpstart Retail and/or its licensors own the
          intellectual property rights for all material on Jumpstart Retail. All
          intellectual property rights are reserved. You may access this from
          Jumpstart Retail for your own personal use subjected to restrictions
          set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul className="p-3 list-disc list-inside">
          <li>Republish material from Jumpstart Retail</li>
          <li>Sell, rent or sub-license material from Jumpstart Retail</li>
          <li>Reproduce, duplicate or copy material from Jumpstart Retail</li>
          <li>Redistribute content from Jumpstart Retail</li>
        </ul>
        <p>
          ...
          information in certain areas of the website. Jumpstart Retail does not
          ...
          Jumpstart Retail,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, Jumpstart Retail shall not be
        ...
        <p>
          Jumpstart Retail reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Jumpstart Retail a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Jumpstart Retail; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Jumpstart Retail. Please include your name, your
        ...
        <p>
          No use of Jumpstart Retail's logo or other artwork will be allowed for
