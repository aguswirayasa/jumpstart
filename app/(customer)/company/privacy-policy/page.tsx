  ...
  return (
    <div className="m-10 md:m-36">
      ...
      <div className="space-y-3 text-justify">
        <p>
          Jumpstart Retails built the Jumpstart app as a Commercial app. This
          SERVICE is provided by Jumpstart Retails and is intended for use as
          is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Jumpstart unless
        ...
        <p>
          ...
          including but not limited to full name, home address, email. The
        ...
        <p>This policy is effective as of 2023-09-15</p>
        <p className="text-xl md:text-2xl font-bold">
          <strong>Contact Us</strong>
        </p>
        <p>
          If you have any questions or suggestions about our Privacy Policy, do
          not hesitate to contact us at jumpstart@gmail.com.
        </p>
        <p>
